...
const departments = ["All", ...Array.from(new Set(defaultDocuments.map((d) => d.department)))];
...
export default function AdminDocumentsPage() {
  ...
  return (
    <AppShell
      title="Documents"
      subtitle="Centralized document repository across all active & processed applications."
      activeRole={role}
    ...
    >
      ...
      <div className="mb-5 flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          <label className="text-xs font-medium text-graphite-500">Department:</label>
          <select
            value={deptFilter}
